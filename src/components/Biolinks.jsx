    import { FaGithub, FaLinkedin, FaWhatsapp, FaEnvelope, FaBriefcase, FaFolder } from "react-icons/fa";
    ...
    const links = [
        ...
        { icon: <FaBriefcase  />,  label: "Portfólio",  url: "https://allan-gustavo-portifolio.vercel.app"},
        {icon: <FaFolder />, label: " Meus Projetos", url: "https://alan-projects.vercel.app"}
